...
<html>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0">
      ...
      <button class="btn btn-warning btn-outline-success my-2 my-sm-0" type="submit">Search
        <span class="brand-icon"><i class="fa fa-arrow-circle-right" style="font-size:20px"></i></span></button>
    </form>
  </div>
</nav>
    </body>
